...
import PostsLatest from '../../../app/components/PostsLatestSection/PostsLatest';
        ...
        <div className="super_container">
          ...
          <div className="jjara_page_content">
            <div className="container">
              <div className="row ">
                <div className="col-lg-9 cat" id="main-content-container">
                  <div className="main_content">
                    <View />
                    <div className="blog_section"></div>
                  </div>
                </div>
                <div className="col-lg-3 cat" id="side-container">
